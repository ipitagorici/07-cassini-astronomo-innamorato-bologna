...
class Frame3(Scene):
    def construct(self):
        ...
        # ANIMATIONS
        self.play(Write(legenda_comet), Write(legenda_observer), Write(legenda_distanza), run_time=0.5)

        self.play(FadeIn(axes1, observer_arc1, observer_arc_label1, observer_point_label1, observer_point, smaller_arc1, bigger_arc1))
        self.play(FadeIn(K_star1, K_label1, L1, L_label1, BL1, comet_position1v2, G_label1, KL, comet_movement_arrow, star_movement_arrow))
